...
description: "Configure Windsurf for writing and maintaining Podium documentation"
icon: "water"
---

Configure Windsurf's Cascade AI assistant to help write and maintain Podium documentation. This guide shows how to set up Windsurf specifically for the Podium docs workflow.
...
- This is the documentation site for the Podium commerce and agentic intelligence platform
- Built on Mintlify — MDX files with YAML frontmatter  
