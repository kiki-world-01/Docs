...
description: "Configure Claude Code for writing and maintaining Podium documentation"
icon: "asterisk"
---

Claude Code is Anthropic's official CLI tool. This guide helps you set up Claude Code to write and maintain Podium documentation.
