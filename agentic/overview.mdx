...
graph TB
    subgraph intelligence ["Intelligence Layer"]
        Sources["Data Sources<br/>(APIs, Web Scraping, Community)"]
        Extract["LLM + Rule Extraction"]
...
| `MARKET_DERIVED` | Enrichment pipeline — scraped reviews, structured APIs, community data | **30%** |
...
<CardGroup cols={2}>
  <Card title="Enrichment Pipeline" icon="flask" href="/agentic/enrichment-pipeline">
    Multi-source product intelligence: crawl, extract, resolve, normalize, baseline. The data engine behind informed agent decisions.
  </Card>
  ...
  <Card title="Beauty Companion" icon="wand-magic-sparkles" href="/agentic/beauty-companion">
    A complete reference implementation: a personal shopping agent built on these primitives with Telegram, Claude, and Privy wallets.
  </Card>
</CardGroup>
