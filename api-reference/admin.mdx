...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/admin/enrichment/crawl-domain \
  -H "Authorization: Bearer $PODIUM_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "domain": "sephora.com",
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/admin/enrichment/map-domain \
  -H "Authorization: Bearer $PODIUM_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/admin/enrichment/serp-search \
  -H "Authorization: Bearer $PODIUM_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "category": "skincare",
...
```bash
curl https://api.podiumcommerce.xyz/api/v1/admin/enrichment/serp-catalog \
  -H "Authorization: Bearer $PODIUM_API_KEY"
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/admin/enrichment/baseline/recompute-now \
  -H "Authorization: Bearer $PODIUM_API_KEY"
```
...
```bash
curl https://api.podiumcommerce.xyz/api/v1/admin/enrichment/baseline/stats \
  -H "Authorization: Bearer $PODIUM_API_KEY"
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/admin/enrichment/catalog-sync \
  -H "Authorization: Bearer $PODIUM_API_KEY"
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/admin/enrichment/reprocess \
  -H "Authorization: Bearer $PODIUM_API_KEY"
```
