...
<Note>
  Most developers interact with API keys and organization settings through the [Podium Developer Portal](https://www.app.podiumcommerce.xyz). The admin API is for programmatic management and platform-level automation.
</Note>
