...
```bash cURL
curl -X POST https://api.podiumcommerce.xyz/api/v1/user/{userId}/order \
...
```bash
curl https://api.podiumcommerce.xyz/api/v1/user/{userId}/order \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/product/{productId} \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X DELETE https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/item/{orderItemId} \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
curl -X POST https://api.podiumcommerce.xyz/api/v1/x402/orders/{orderId}/pay
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/points \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{ "points": 500 }'
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/discount \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{ "code": "SUMMER2026" }'
```
...
```bash
curl -X PUT https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/points/finalize \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/points/revert \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://api.podiumcommerce.xyz/api/v1/creator/id/{creatorId}/order/{orderId}/shipping/label \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/guest/order \
  -H "Content-Type: application/json" \
  -d '{
    "productId": "clx9prod001",
    "variantIds": ["clx9var001"],
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/guest/order/{orderId}/checkout
```
...
```bash
curl -X PATCH https://api.podiumcommerce.xyz/api/v1/guest/order/{orderId}/checkout/coinbase \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST https://api.podiumcommerce.xyz/api/v1/user/{userId}/order/{orderId}/payment-failed \
  -H "Authorization: Bearer YOUR_API_KEY"
```
