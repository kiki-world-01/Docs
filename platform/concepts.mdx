...
| `NFT_REDEMPTION` | Spent when redeeming NFT rewards |
...
Podium supports on-chain NFT minting and reward redemption:
...
| `Airdrop` | Scheduled bulk NFT distribution |

NFT rewards support six types: `POINTS`, `FREE_PRODUCT`, `DISCOUNT_CODE`, `EVENT_PASS`, `CUSTOM`, and `EXCLUSIVE_ACCESS`.
