...
API keys are self-service through the [Podium Developer Portal](https://www.podiumcommerce.xyz/onboarding):
...
From the [API Keys dashboard](https://www.podiumcommerce.xyz/dashboard/settings/api-keys), you can:
...
Upgrade your tier from the [Dashboard](https://www.podiumcommerce.xyz/dashboard/settings/subscription) to unlock additional API surface.
