...
<CardGroup cols={2}>
  <Card title="Memory Intelligence" icon="brain" href="/agentic/memory-intelligence">
  ...
  <Card title="Subscription Monetization" icon="credit-card" href="/platform/subscriptions">
    Add paid tiers to your companion agents with Stripe billing, usage gating, and memory-as-premium
  </Card>
  <Card title="Creator Agents" icon="wand-magic-sparkles" href="/agentic/beauty-companion">
