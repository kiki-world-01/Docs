...
<Steps>
  <Step title="Sign up">
    Head to the [Podium Developer Portal](https://www.app.podiumcommerce.xyz) and sign in with email, Google, or a crypto wallet (powered by Privy).
  </Step>
...
From the [Dashboard](https://www.app.podiumcommerce.xyz/dashboard/settings/api-keys) you can:
